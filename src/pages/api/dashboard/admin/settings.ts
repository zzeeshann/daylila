 ...
 *     boolean (400).
 *
 * Historical note: a `reading_mode` key was added in C4 (2026-05-08)
 * to gate the beat-by-beat reading mode rollout, then removed from
 * this API in C7 (same day) once paginated became the only mode. The
 * D1 row at `admin_settings.reading_mode = 'scroll'` is left inert
 * (no consumer) per the non-destructive default; migration 0041
 * stays in history.
 */
