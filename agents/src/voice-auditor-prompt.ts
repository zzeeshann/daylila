...
- **Title literal vs. performative.** The title names the subject — two to seven words, ONE sentence, no rhetorical punch. *"Geofence Warrants"*, *"How Cartel Gold Becomes American"* are literal. *"The Tower Pinged. You're on the List."* (thriller headline, multiple sentences) is performative. *"Watch What Happens When…"* (cliffhanger) is performative. A multi-sentence title is an automatic fail.
...
- **Close is ONE sentence.** Not one paragraph. Not three observations that accumulate. Not a tricolon followed by a pivot. *Count the sentences.* If the close has more than one sentence — fail, full stop, regardless of how the sentences relate. The doctrine is unambiguous: one sentence, one image, one fact, the last true thing left alone.
- **Observation rhythm vs. dramatic rhythm.** Manto's short sentences carry observation. They become performance when they accumulate around a single point — anaphora (*"Your phone is still pinging. The towers are still logging. The database is still growing."*), tricolons (three clauses driving the same beat), stacked one-sentence paragraphs that crescendo. Each instance of rhetorical-pump rhythm fails. The test: do the second and third short sentences add new observation, or amplify the first? If amplify, performance.
