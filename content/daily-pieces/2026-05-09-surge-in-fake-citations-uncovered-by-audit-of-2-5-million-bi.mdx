...
newsSource: "Nature"
claimReviews: ["An audit of 2.5 million biomedical papers found thousands of citations pointing to papers that don't exist","The audit was led by Columbia University's Maxim Topaz","Paper mills charge fees often $1,000 to $5,000 for authorship on fabricated papers","The audit used two approaches: DOI and PubMed ID validation, and database searches","Thousands of DOIs didn't resolve or pointed to nothing despite being formatted correctly","Some mills create fake journals with real-looking websites and DOI prefixes purchased from legitimate registrars","A single paper might cite 30 to 50 references","Peer review doesn't verify references - reviewers don't look up every DOI","Journals are adding automated DOI checks now"]
audioBeats:
